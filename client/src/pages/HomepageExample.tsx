    ...
    <div className="min-h-screen bg-[#05080d] px-3 py-3 sm:px-5 sm:py-5">
      <main className="mx-auto max-w-[1600px] rounded-[18px] border border-[#c69d58]/35 bg-[#080c13] p-3 shadow-2xl shadow-black/40 sm:p-4">
        ...
        <section className="mt-3 rounded-md border border-[#c69d58]/35 bg-[#0a0e15] p-3"><div className="grid gap-3 lg:grid-cols-4">
          ...
          <Link href="/world" className="relative min-h-[185px] overflow-hidden rounded-sm border border-white/10 bg-[#091422] p-3"><p className="relative z-10 text-[9px] font-bold uppercase tracking-[0.15em] text-[#c69d58]"><Globe2 className="mr-1 inline" size={11} />World Elections Page</p><h3 className="relative z-10 mt-4 max-w-[58%] text-base font-bold leading-tight">Global democracy. Black voices. Local impact.</h3><div aria-hidden className="absolute bottom-[-40px] right-[-27px] h-48 w-48 rounded-full border border-cyan-200/45 bg-[radial-gradient(circle_at_35%_30%,rgba(148,226,255,0.5),rgba(37,94,158,0.28)_38%,rgba(5,19,43,0.98)_69%)] shadow-[inset_-25px_-15px_42px_rgba(0,0,0,.7)] animate-[spin_36s_linear_infinite]"><div className="absolute inset-y-5 left-1/2 w-12 -translate-x-1/2 rounded-[50%] border-x border-cyan-100/35" /><div className="absolute inset-x-4 top-1/2 h-8 -translate-y-1/2 rounded-[50%] border-y border-cyan-100/35" /></div><span className="relative z-10 mt-14 inline-flex items-center gap-1 text-[10px] font-semibold text-[#c69d58]">Explore the globe <ArrowUpRight size={11} /></span></Link>
