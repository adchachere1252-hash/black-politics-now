...
export default function Atlas() {
  ...
  const { data: approvedEditorialNotes = [] } = trpc.atlasOperations.publicNotes.useQuery({ stateCode: selected?.stateCode ?? "AL", congress: selectedCongress }, { enabled: Boolean(selected?.stateCode) });
