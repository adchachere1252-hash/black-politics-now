  ...
  return (
    <div className="space-y-6">
      <div className="glass-card rounded-xl p-5">
        ...
        <button onClick={submitCandidate} disabled={submit.isPending} className="mt-4 rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground disabled:opacity-50">{submit.isPending ? "Submitting…" : "Submit for provenance review"}</button>
      </div>
